...
const AndroidConsumption = () => {
  ...
  const loadData = async () => {
    try {
      ...
      const apiData = response.data.consumption.find(series => series.name === "MOBILE-ANDROID");
      if (apiData) {
...
export default AndroidConsumption;
