...
const BrowserConsumption = () => {
  ...
  const loadData = async () => {
    try {
      ...
      const apiData = response.data.consumption.find(series => series.name === "BROWSER PAGE LOAD");
      if (apiData) {
...
export default BrowserConsumption;
